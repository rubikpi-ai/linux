...
typedef PACK_START struct _apcmdbuf_pmf_params {
	...
	PACK_START struct {
		...
		t_u8 beacon_prot : 1; /* beacon protection bit */
		t_u8 rsvd : 5;
	} PACK_END params;
...
/** Host Command ID : 802.11D beacon IE configuration */
#define HostCmd_CMD_802_CUSTOM_BEACON_IE 0x0281
