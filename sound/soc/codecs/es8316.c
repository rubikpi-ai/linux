...
{
//	struct es8336_priv *es8316 =
		//	container_of(work, struct es8316_priv, pcm_pop_work);
...
static int es8316_probe(struct snd_soc_component *component)
{
	...
	pr_err("[LYK] [%s] [%d]ret[%d]",__func__,__LINE__,ret);
	if (ret)
		return ret;
#endif
	ret = snd_soc_component_read(component, ES8316_CLKMGR_ADCDIV2_REG05);
...
static void es8316_device_connect_status_notify(es8316_connection_status status)
{
