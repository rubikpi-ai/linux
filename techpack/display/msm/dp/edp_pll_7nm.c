...
static const struct dp_pll_params pll_params[EDP_HSCLK_RATE_MAX] = {
		{0x05, 0x3f, 0x00, 0x08, 0x01, 0x69, 0x00, 0x80, 0x07, 0x6f,
				0x08, 0x45, 0x06, 0x36, 0x01, 0x00, 0x00,
				0x0f, 0x0a, 0x1f, 0x0a, 0x11},
		{0x04, 0x3f, 0x00, 0x04, 0x01, 0x70, 0x00, 0x00, 0x08, 0x3f,
				0x0b, 0xb0, 0x06, 0x36, 0x01, 0x00, 0x00,
				0x0f, 0x0a, 0x1f, 0x0a, 0x11},
		{0x04, 0x3f, 0x00, 0x04, 0x01, 0x7e, 0x00, 0x00, 0x09, 0xa7,
				0x0c, 0x86, 0x07, 0x36, 0x01, 0x00, 0x00,
				0x0f, 0x0a, 0x1f, 0x0a, 0x11},
		{0x03, 0x3f, 0x00, 0x08, 0x01, 0x69, 0x00, 0x80, 0x07, 0x0f,
				0x0e, 0x45, 0x06, 0x36, 0x01, 0x00, 0x00,
				0x0f, 0x0a, 0x1f, 0x0a, 0x11},
		{0x03, 0x3f, 0x00, 0x04, 0x02, 0x7e, 0x00, 0x00, 0x09, 0xdf,
				0x10, 0x86, 0x07, 0x36, 0x01, 0x00, 0x00,
				0x0f, 0x0a, 0x1f, 0x0a, 0x11},
		{0x01, 0x3f, 0x00, 0x04, 0x02, 0x70, 0x00, 0x00, 0x08, 0x7f,
				0x16, 0xb0, 0x06, 0x36, 0x01, 0x00, 0x00,
				0x0f, 0x0a, 0x1f, 0x0a, 0x11},
		{0x01, 0x3f, 0x00, 0x08, 0x02, 0x8c, 0x00, 0x00, 0x0a, 0x1f,
				0x1c, 0x5c, 0x08, 0x36, 0x01, 0x00, 0x00,
				0x0f, 0x0a, 0x1f, 0x0a, 0x11},
		{0x01, 0x3f, 0x00, 0x04, 0x00, 0x9a, 0x00, 0x00, 0x0b, 0xef,
				0x1e, 0x33, 0x09, 0x36, 0x01, 0x00, 0x00,
				0x0f, 0x0a, 0x1f, 0x0a, 0x11},
		{0x00, 0x3f, 0x00, 0x08, 0x00, 0x69, 0x00, 0x80, 0x07, 0x2f,
				0x2a, 0x45, 0x06, 0x36, 0x01, 0x00, 0x00,
				0x0f, 0x0a, 0x1f, 0x0a, 0x11},
};
		...
		unsigned long rate)
{
	...
	case DP_VCO_HSCLK_RATE_1620MHZDIV1000:
		...
		pdb->rate_idx = EDP_HSCLK_RATE_1620MHZ;
		break;
	case DP_VCO_HSCLK_RATE_2160MHZDIV1000:
		DP_DEBUG("VCO rate: %ld\n", DP_VCO_RATE_10800MHZDIV1000);
		pdb->rate_idx = EDP_HSCLK_RATE_2160MHZ;
		break;
	case DP_VCO_HSCLK_RATE_2430MHZDIV1000:
		DP_DEBUG("VCO rate: %ld\n", DP_VCO_RATE_10800MHZDIV1000);
		pdb->rate_idx = EDP_HSCLK_RATE_2430MHZ;
		break;
	case DP_VCO_HSCLK_RATE_2700MHZDIV1000:
		DP_DEBUG("VCO rate: %ld\n", DP_VCO_RATE_10800MHZDIV1000);
		pdb->rate_idx = EDP_HSCLK_RATE_2700MHZ;
		break;
	case DP_VCO_HSCLK_RATE_3240MHZDIV1000:
		DP_DEBUG("VCO rate: %ld\n", DP_VCO_RATE_10800MHZDIV1000);
		pdb->rate_idx = EDP_HSCLK_RATE_3240MHZ;
		break;
	case DP_VCO_HSCLK_RATE_4320MHZDIV1000:
		DP_DEBUG("VCO rate: %ld\n", DP_VCO_RATE_10800MHZDIV1000);
		pdb->rate_idx = EDP_HSCLK_RATE_4320MHZ;
		break;
	case DP_VCO_HSCLK_RATE_5400MHZDIV1000:
		DP_DEBUG("VCO rate: %ld\n", DP_VCO_RATE_10800MHZDIV1000);
		pdb->rate_idx = EDP_HSCLK_RATE_5400MHZ;
		break;
	case DP_VCO_HSCLK_RATE_5940MHZDIV1000:
		DP_DEBUG("VCO rate: %ld\n", DP_VCO_RATE_8100MHZDIV1000);
		pdb->rate_idx = EDP_HSCLK_RATE_5940MHZ;
		break;
	case DP_VCO_HSCLK_RATE_8100MHZDIV1000:
		DP_DEBUG("VCO rate: %ld\n", DP_VCO_RATE_8100MHZDIV1000);
		pdb->rate_idx = EDP_HSCLK_RATE_8100MHZ;
		break;
	default:
...
static int edp_vco_clk_set_div(struct dp_pll *pll, unsigned long rate)
{
	u32 div, val = 0;
	...
	val = dp_pll_read(dp_phy, DP_PHY_VCO_DIV_V500);
	val &= ~0x03;
	...
	dp_pll_write(dp_phy, DP_PHY_VCO_DIV_V500, val);
		...
		unsigned long rate)
{
	...
	if (pdb->rate_idx < EDP_HSCLK_RATE_MAX) {
	...
	dp_pll_write(dp_phy, DP_PHY_VCO_DIV_V500, params->phy_vco_div);
	/* Make sure the PLL register writes are done */
	wmb();
	...
	return edp_vco_clk_set_div(pll, rate);
}
					...
					unsigned long parent_rate)
{
	...
	rate = edp_pll_vco_div_clk_get_rate(pll);
	DP_DEBUG("rate %lu\n", rate);
